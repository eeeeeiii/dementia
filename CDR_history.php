            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <form action="CDR_history.php" method="get">
                    ...
                    <style>
                      ...
                      <table class="table" style="text-align:center;">
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_cdr = "SELECT * FROM cdr where id='$id' AND account='$selection' order by date desc";
                          ...
                          ?>
                          <?php while($record_cdr = mysqli_fetch_assoc($result_cdr)){?>
                          <tr>
                            <td><?php echo $record_cdr['num'] ?></td>
                            <td><?php echo $record_cdr['sum_of_box'] ?></td>
                            <td><?php echo $record_cdr['freetyping'] ?></td>
                            <td><?php echo $record_cdr['date'] ?></td>
                            <td><?php echo $record_cdr['name']?>(<?php echo $record_cdr['account']?>)</td>
                            <td>
                              <form action="CDR_history_data.php" method="get">
                                <button type="submit" class="btn" style="text-decoration:underline;" name="num_index" value="<?php echo $record_cdr['num'] ?>"><i class='	fas fa-eye'></i></button>
                              </form>
                            </td>
                            </tr>
                          <?php } ?>
