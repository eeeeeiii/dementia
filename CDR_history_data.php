<?php
  ...
  $_SESSION['cdr_num_index'] = $num_index;

  $sql = "SELECT id, name FROM patient_basic where id='$id'";
  $result = mysqli_query($link, $sql);
  $record = mysqli_fetch_assoc($result); 

  $sql_cdr = "SELECT * FROM cdr where id='$id' and num='$num_index'";
  $result_cdr = mysqli_query($link, $sql_cdr);
  $record_cdr = mysqli_fetch_assoc($result_cdr);

  $sql_cdr_mem = "SELECT * FROM cdr_memory where id='$id' and date='$record_cdr[date]'";
  $result_cdr_mem = mysqli_query($link, $sql_cdr_mem);
  $record_mem = mysqli_fetch_assoc($result_cdr_mem);

  $sql_cdr_ori = "SELECT * FROM cdr_orientation where id='$id' and date='$record_cdr[date]'";
  $result_cdr_ori = mysqli_query($link, $sql_cdr_ori);
  $record_ori = mysqli_fetch_assoc($result_cdr_ori);

  $sql_cdr_jug = "SELECT * FROM cdr_judgment_and_problem_solving where id='$id' and date='$record_cdr[date]'";
  $result_cdr_jug = mysqli_query($link, $sql_cdr_jug);
  $record_jug = mysqli_fetch_assoc($result_cdr_jug);

  $sql_cdr_com = "SELECT * FROM cdr_community_affairs where id='$id' and date='$record_cdr[date]'";
  $result_cdr_com = mysqli_query($link, $sql_cdr_com);
  $record_com = mysqli_fetch_assoc($result_cdr_com); 

  $sql_cdr_home = "SELECT * FROM cdr_home_and_hobbies where id='$id' and date='$record_cdr[date]'";
  $result_cdr_home = mysqli_query($link, $sql_cdr_home);
  $record_home = mysqli_fetch_assoc($result_cdr_home);

  $sql_cdr_per = "SELECT * FROM cdr_personal_care where id='$id' and date='$record_cdr[date]'";
  $result_cdr_per = mysqli_query($link, $sql_cdr_per);
  $record_per = mysqli_fetch_assoc($result_cdr_per);

  $sql_revise = "SELECT * FROM revise where id='$id' and revise_table='cdr' and cdr_num='$num_index' order by date desc";
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         <?php if ($record_user['doctor'] == 1 || $record_user['psychologist'] == 1){ ?>
          ...
          <input type="hidden" name="revise" value="cdr">
                      ...
                      <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">CDR失智評分量表</span></h3>
                        <div class="row  align-items-end">
                          ...
                          <div class="mb-3 col-md-2">
                            <input type="date" class="form-control" name="cdr_record_time" value="<?php echo $record_cdr['record_time'] ?>">
                          </div>
                          ...
                          <div class="mb-3 col-md-2 ">
                            ...
                            <?php if($record_mem['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_mem['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_mem['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_mem['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_mem['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            ...
                            <input class="form-control" type="text"  name="cdr_memory_text"  placeholder="說明"value="<?php echo $record_mem['freetyping']?>">
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                          ...
                          <div class="mb-3 col-md-2 ">
                            ...
                            <?php if($record_ori['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_ori['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_ori['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_ori['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_ori['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label  class="form-label">&nbsp;</label>
                            <input type="text" class="form-control"name="cdr_orientation_text"value="<?php echo $record_ori['freetyping']?>"placeholder="說明">
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                          ...
                          <div class="mb-3 col-md-2 ">
                            ...
                            <?php if($record_jug['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_jug['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_jug['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_jug['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_jug['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            ...
                            <input type="text" class="form-control" name="cdr_judgment_and_problem_solving_text" value="<?php echo $record_jug['freetyping']?>" placeholder="說明">
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                          ...
                          <div class="mb-3 col-md-2 ">
                            ...
                            <?php if($record_com['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_com['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_com['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_com['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_com['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_community_affairs_text" value="<?php echo $record_com['freetyping']?>"placeholder="說明">
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                          ...
                          <div class="mb-3 col-md-2 ">
                            ...
                            <?php if($record_home['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_home['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_home['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_home['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_home['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label  class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_home_and_hobbies_text" value="<?php echo $record_home['freetyping']?>" placeholder="說明">
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                          ...
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            ...
                            <?php if($record_per['content'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_per['content'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_per['content'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_per['content'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_per['content'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            ...
                            <input type="text" class="form-control" name="cdr_personal_care_text" value="<?php echo $record_per['freetyping']?>" placeholder="說明">
                          </div>
                          <div class="mb-3 col-md-1 mt-3" style="text-align:center;">
                            <label class="form-label"  style="font-size:16px;">原總分</label>
                            <h4 ><?php echo $record_cdr['sum_of_box']?></h4>
                          </div>
                          <div class="mb-3 col-md-1 mt-3" style="text-align:center;">
                            <label class="form-label"  style="font-size:16px;">修改後<br>總分</label>
                            <h4 id=sum_cox_box><?php echo $record_cdr['sum_of_box']?></h4>
                          </div>
                          <div class="mb-3 col-md-8 mt-3">
                              <label for="currency" class="form-label" style="font-size:16px;" >總結</label>
                              <input type="text" class="form-control" name="cdr_freetyping" value="<?php echo $record_cdr['freetyping']?>" placeholder="總結">
                          </div>
                              ...
                              <?php if($record_cdr['cdr'] == '0'){ ?>
                              <option value="0" selected>0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_cdr['cdr'] == '0.5'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5" selected>0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_cdr['cdr'] == '1'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1" selected>1分</option>
                              <option value="2">2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_cdr['cdr'] == '2'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2" selected>2分</option>
                              <option value="3">3分</option>
                            <?php }else if($record_cdr['cdr'] == '3'){ ?>
                              <option value="0">0分</option>
                              <option value="0.5">0.5分</option>
                              <option value="1">1分</option>
                              <option value="2">2分</option>
                    ...
                    <div class="row">
                      ...
                      <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">CDR失智評分量表</span></h3>
                        <div class="row  align-items-end">
                          ...
                          <div class="mb-3 col-md-2">
                            <input type="date" class="form-control" name="cdr_record_time" value="<?php echo $record_cdr['record_time'] ?>" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>記憶力</label>
                          </div>
                          <div class="mb-3 col-md-2 ">
                            <select name="cdr_memory" class="select2 form-select" id="memory" onchange="sum()"  disabled>
                              <?php if (isset($record_cdr)){?><option value="<?php echo $record_mem['content'] ?>"><?php echo $record_mem['content'] ?>分</option> <?php }?>
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label  class="form-label">&nbsp;</label>
                            <input class="form-control" type="text"  name="cdr_memory_text"  placeholder="說明"value="<?php echo $record_mem['freetyping']?>" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label  class="form-label" style='font-size:16px;'>定向感</label>
                          </div>
                          <div class="mb-3 col-md-2 ">
                            <select name="cdr_orientation" class="select2 form-select" id="orientation" onchange="sum()" disabled>
                            <?php if (isset($record_cdr)){?><option value="<?php echo $record_ori['content'] ?>"><?php echo $record_ori['content'] ?>分</option><?php }?>
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label  class="form-label">&nbsp;</label>
                            <input type="text" class="form-control"name="cdr_orientation_text"value="<?php echo $record_ori['freetyping']?>"placeholder="說明" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label class="form-label" style='font-size:16px;' >解決問題能力</label>
                          </div>
                          <div class="mb-3 col-md-2 ">
                            <div class="input-group input-group-merge">
                            <select name="cdr_judgment_and_problem_solving" class="select2 form-select" id="jugment" onchange="sum()" disabled>
                            <?php if (isset($record_cdr)){?><option value="<?php echo $record_jug['content'] ?>"><?php echo $record_jug['content'] ?>分</option><?php }?>
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label for="address" class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_judgment_and_problem_solving_text" value="<?php echo $record_jug['freetyping']?>" placeholder="說明" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label for="state" class="form-label" style='font-size:16px;'>社區活動能力</label>
                          </div>
                          <div class="mb-3 col-md-2 ">
                            <select name="cdr_community_affairs" class="select2 form-select" id="community" onchange="sum()" disabled>
                            <?php if (isset($record_cdr)){?> <option value="<?php echo $record_com['content'] ?>"><?php echo $record_com['content'] ?>分</option><?php }?>
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_community_affairs_text" value="<?php echo $record_com['freetyping']?>"placeholder="說明" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label class="form-label" for="country" style='font-size:16px;'>居家嗜好</label>
                            </div>
                          <div class="mb-3 col-md-2 ">
                            <select name="cdr_home_and_hobbies" class="select2 form-select" id="home" onchange="sum()" disabled>
                            <?php if (isset($record_cdr)){?> <option value="<?php echo $record_home['content'] ?>"><?php echo $record_home['content'] ?>分</option><?php }?> 
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label  class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_home_and_hobbies_text" value="<?php echo $record_home['freetyping']?>" placeholder="說明" readonly>
                          </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <label for="timeZones" class="form-label" style='font-size:16px;'>自我照料</label>
                            </div>
                          <div class="mb-3 col-md-2 " style="text-align:center;">
                            <select name="cdr_personal_care" class="select2 form-select" id="personal" onchange="sum()" disabled>
                            <?php if (isset($record_cdr)){?> <option value="<?php echo $record_per['content'] ?>"><?php echo $record_per['content'] ?>分</option><?php }?>
                              <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
                          ...
                          <div class="mb-3 col-md-8">
                            <label for="currency" class="form-label">&nbsp;</label>
                            <input type="text" class="form-control" name="cdr_personal_care_text" value="<?php echo $record_per['freetyping']?>" placeholder="說明" readonly>
                          </div>
                          <div class="mb-3 col-md-2 mt-2" style="text-align:center;">
                            <label class="form-label" style="font-size:16px;">總分</label>
                            <h4 id=sum_cox_box><?php echo $record_cdr['sum_of_box']?></h4>
                          </div>
                          <div class="mb-3 col-md-8 mt-2" >
                            <label for="currency" class="form-label" style="font-size:16px;">總結</label>
                            <input type="text" class="form-control" name="cdr_freetyping" value="<?php echo $record_cdr['freetyping']?>"placeholder="總結" readonly>
                          </div>
                            <div class="mb-3 col-md-2 mt-2" >
                              <label class="form-label"  style="font-size:16px;">CDR判分</label>
                              <select class="select2 form-select" name="cdr_rating" disabled>
                                <option value="<?php echo $record_cdr['cdr'] ?>"><?php echo $record_cdr['cdr'] ?>分</option>                    
                                <option value="0">0分</option>
                                <option value="0.5">0.5分</option>
                                <option value="1">1分</option>
                                <option value="2">2分</option>
