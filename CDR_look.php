<?php
  ...
  $sql_revise = "SELECT * FROM revise where id='$id' and revise_table='cdr' and cdr_num='$record_cdr[num]' order by date desc";
            ...
            <?php if(empty($record_cdr['id'])){ ?>
              <script>
                swal({
                  ...
                  location.href='CDR_insert.php';
                });
              </script>
            <?php } ?>
            <?php if(isset($record_cdr['id'])){ ?>
