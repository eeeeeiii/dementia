              ...
              <div class="row">
                <div class="col-md-12"><div class="card mb-4">
                    ...
                    <div class="row">
                      ...
                      <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">病程預測</span></h3>
                        <div class="row  align-items-center">
                          <!-- patient basic -->
                          <div class="col-md-12 ">
                           <h4 class="fw-bold py-3 mb-4"> 基本資料</h4>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>AGE</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record['age']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Edu</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record['education']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'> HSEX_F</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo $HSEX_F;?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>HSEX_M</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo $HSEX_M;?></span></center>
                          </div><div class="mb-4 col-md-8 "></div><hr style="height:1.5px;">

                          <!-- cdr -->
                          <div class="col-md-12 ">
                           <h4 class="fw-bold py-3 mb-4"> CDR</h4>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Memory</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_mem['content']);?></span></center> 
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Orientation</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_ori['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'> Judgment and Problem Solving</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_jug['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Community Affairsl</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_com['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Home and Hobbies</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_home['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>Personal Care</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo floatval($record_per['content']);?></span></center>
                          </div>
                          <hr style="height:1.5px;">

                          <!-- mmse -->
                          <div class="col-md-12 ">
                           <h4 class="fw-bold py-3 mb-4"> MMSE</h4>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE Orientation</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_time['content'])+intval($record_place['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE time</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_time['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE place</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_place['content']);?></span></center>
                          </div><div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE Registration</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_reg['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE Attention and calculation</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_7['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE Recall</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo  intval($record_recall['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-2 " style="text-align:center;">
                            <label class="form-label"  style='font-size:16px;'>MMSE Language</label>
                          </div>
                          <div class="mb-4 col-md-1 ">
                            <center><span class="form-control" style="background-color:#eceef1;" type="text"><?php echo intval($record_lan_name['content'])+intval($record_lan_read['content'])+intval($record_lan_repeat['content'])+intval($record_lan_write['content']);?></span></center>
                          </div>
                          <div class="mb-4 col-md-10 "></div>
                          <div class="mt-2 col-md-2" style='text-align:right;'>
                            <button id="fastapi" class="btn btn-primary me-2" style="font-size:16px;">預測</button>
                          </div>
                        </div>
                        ...
                        <script>
                          //傳給python的資料
                          const requestData = {
                              "AGE": '<?php echo intval($record['age']);?>',
                              "Edu": '<?php echo intval($record['education']);?>', 
                              "Memory" : '<?php echo floatval($record_mem['content']);?>',
                              "Orientation" : '<?php echo floatval($record_ori['content']);?>',
                              "Judgment_and_Problem_Solving" : '<?php echo floatval($record_jug['content']);?>',
                              "Community_Affairsl": '<?php echo floatval($record_com['content']);?>',
                              "Home_and_Hobbies" : '<?php echo floatval($record_home['content']);?>',
                              "Personal_Care" :'<?php echo floatval($record_per['content']);?>',
                              "MMSE_Orientation" : '<?php echo intval($record_time['content'])+intval($record_place['content']);?>',
                              "MMSE_time" : '<?php echo intval($record_time['content']);?>',
                              "MMSE_place" : '<?php echo intval($record_place['content']);?>',
                              "MMSE_Registration" : '<?php echo intval($record_reg['content']);?>',
                              "MMSE_Attention_and_calculation" : '<?php echo intval($record_7['content']);?>',
                              "MMSE_Recall" :'<?php echo  intval($record_recall['content']);?>',
                              "MMSE_Language" : '<?php echo intval($record_lan_name['content'])+intval($record_lan_read['content'])+intval($record_lan_repeat['content'])+intval($record_lan_write['content']);?>',
                              "HSEX_F" : '<?php echo $HSEX_F;?>',
                              "HSEX_M" : '<?php echo $HSEX_M;?>',
                          };
                          //按鈕觸發axios請求
                          $(document).ready(function() {
                            $("#fastapi").on("click", function() {
                              ...
                              .then(response => {
                                ...
                                if(result == 1) {
                                  responseDiv.innerHTML = "可能惡化";
                                } else {
                                  responseDiv.innerHTML = "維持";
                                }
                                //shap圖片
                                var imgElement = document.createElement("img");
                                imgElement.setAttribute("src", 'data:image/png;base64,' + response.data.shap_image);
                                document.getElementById("image-container").appendChild(imgElement);
                                //隱藏按鈕
                                var button = document.querySelector("#fastapi");
                                button.style.display = "none";
                                //ajax請求給php
                                $.ajax({
                                type: "POST",
                                url: "insert_predict.php",
                                data: {
                                  result: result,
                                  id: "<?php echo $id?>"
                                },
                      ...
                      <div id="output"  style="display:none;">
                        <div class="parent-div">
                          <div class="mb-3 inline-block" style="font-size:24px;font-weight: bold; margin-right: 0;">預測結果：</div>
                          <div class="mb-3 inline-block">
                            <div id="response" style='font-size:24px; white-space: nowrap;font-weight: bold;'></div>
                          </div>
                        </div>
                        <div class="mb-3 col-md-12 ">
                          <p>下方長條圖為各特徵影響的程度分析，藍色代表該特徵對預測有負向影響，紅色代表該特徵對預測有正向影響。</p>
