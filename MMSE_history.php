            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <form action="MMSE_history.php" method="get">
                    ...
                    <style>
                      ...
                      <table class="table" style="text-align:center;">
                          <tr>
                            ...
                            <th><font size="3">總分</font></th>
                            <th><font size="3">總結</font></th>
                            <th><font size="3">紀錄時間</font></th>
                            <th><font size="3">紀錄人員</font></th>
                            <th><font size="3">查看</font></th>
                          </tr>
                          <?php 
                            $selection = $_GET['selection'];
                            if(!empty($selection)){
                              $sql_mmse = "SELECT * FROM mmse where id='$id' AND account='$selection' order by date desc";
                          ...
                          ?>
                          <?php while($record_mmse = mysqli_fetch_assoc($result_mmse)){?>
                          <tr>
                            <td><?php echo $record_mmse['num'] ?></td>
                            <td><?php echo $record_mmse['total'] ?></td>
                            <td><?php echo $record_mmse['freetyping'] ?></td>
                            <td><?php echo $record_mmse['date'] ?></td>
                            <td><?php echo $record_mmse['name'] ?>(<?php echo $record_mmse['account'] ?>)</td>
                            <td>
                              <form action="MMSE_history_data.php" method="get">
                              <button type="submit" class="btn" style="text-decoration:underline;" name="num_index" value="<?php echo $record_mmse['num'] ?>"><i class='fas fa-eye'></i></button>
                            </form>
                          </td>
                          </tr>
                          <?php } ?>
