<?php
 ...
 $_SESSION['mmse_num_index'] = $num_index;

 $sql = "SELECT id, name FROM patient_basic where id='$id'";
 $result = mysqli_query($link, $sql); 
 $record = mysqli_fetch_assoc($result); 

 $sql_mmse = "SELECT * FROM mmse where id='$id' and num='$num_index'";
 ...
 $sql_revise = "SELECT * FROM revise where id='$id' and revise_table='mmse' and mmse_num='$num_index' order by date desc";
