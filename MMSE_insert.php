          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">新增MMSE簡易智能檢查</h3>
                    <div class="row align-items-top">
                          ...
                          <div class="mb-3 col-md-2">
                            <input type="date" class="form-control" name="mmse_record_time"  >
                          </div>
                          ...
                          <div class=" col-md-8">
                            <input type="text" class="form-control" name="mmse_time_text" placeholder="說明" >
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_place_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_reg_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div> 
                          <div class="mb-3 col-md-2"  style="text-align:center;margin-top:8px;">
                          ...
                          <div class="mb-3 col-md-8">
                            <input type="text" class="form-control" name="mmse_7_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_recall_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_lan_name_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          <div class="col-md-2"  style="text-align:center;margin-top:8px;">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_lan_repeat_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          <div class="col-md-2"  style="text-align:center;margin-top:8px;">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_lan_read_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          <div class="col-md-2"  style="text-align:center;margin-top:8px;">
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_lan_write_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          <div class="mb-3 col-md-2" style="text-align:center;margin-top:8px;">
                          ...
                          <div class="mb-3 col-md-8">
                            <input type="text" class="form-control" name="mmse_action_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          ...
                          <div class="col-md-8">
                            <input type="text" class="form-control" name="mmse_build_text" placeholder="說明" >
                            <label for="address" class="form-label">&nbsp;</label>
                          </div>
                          ...
                          <div class="mb-3 col-md-10 mt-3">
                            ...
                            <input type="text" class="form-control" name="mmse_freetyping" placeholder="總結">
                          </div>
