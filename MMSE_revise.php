            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                    <form action="MMSE_revise.php" method="get">
                    ...
                    <style>
                      ...
                      <table class="table" style="text-align:center;">
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='mmse' AND account='$selection' order by date desc";
                              $result_revise = mysqli_query($link, $sql_revise);
                            }else{
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='mmse' order by date desc";
                              $result_revise = mysqli_query($link, $sql_revise);
                            }
                          ?>
                          <?php while($record_revise = mysqli_fetch_assoc($result_revise)){?>
                          <tr>
                            <td><?php echo $record_revise['mmse_num'] ?></td>
                            <td><?php echo $record_revise['revise_column'] ?></td>
                            <td>
                              <?php if($record_revise['revise_column'] == '語言-口語理解及行用能力' or $record_revise['revise_column'] == '建構力' or $record_revise['revise_column'] == '定向感-時間' or $record_revise['revise_column'] == '定向感-地方' or $record_revise['revise_column'] == '注意力-信息登錄' or $record_revise['revise_column'] == '注意力-系列減七' or $record_revise['revise_column'] == '回憶' or $record_revise['revise_column'] == '語言-命名' or $record_revise['revise_column'] == '語言-複誦' or $record_revise['revise_column'] == '語言-閱讀理解' or $record_revise['revise_column'] == '語言-書寫造句') { echo trim($record_revise['original_data']); ?>分
                              <?php }else{echo trim($record_revise['original_data']);}?>
                            </td>
                            <td>
                              <?php if($record_revise['revise_column'] == '語言-口語理解及行用能力' or $record_revise['revise_column'] == '建構力' or $record_revise['revise_column'] == '定向感-時間' or $record_revise['revise_column'] == '定向感-地方' or $record_revise['revise_column'] == '注意力-信息登錄' or $record_revise['revise_column'] == '注意力-系列減七' or $record_revise['revise_column'] == '回憶' or $record_revise['revise_column'] == '語言-命名' or $record_revise['revise_column'] == '語言-複誦' or $record_revise['revise_column'] == '語言-閱讀理解' or $record_revise['revise_column'] == '語言-書寫造句') { echo trim($record_revise['new_data']); ?>分
                              <?php }else{echo trim($record_revise['new_data']);}?>
                            </td>
