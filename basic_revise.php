<?php
  ...
  $sql_selection = "SELECT * FROM user WHERE doctor=1 or personal_manager=1 or psychologist=1 or nurse=1";
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form action="basic_revise.php" method="get">
                      ...
                      <style>
                        ...
                        <table class="table" style="text-align:center;"> 
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='基本資料' AND account='$selection' order by date desc";
