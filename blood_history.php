<?php
  ...
  $sql_selection = "SELECT * FROM user WHERE doctor=1 or nurse=1";
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form action="blood_history.php" method="get">
                        ...
                        <table class="table" style="text-align:center;">
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_blood = "SELECT * FROM blood where id='$id' AND account='$selection' order by date desc";
                          ...
                          ?>
                            <td><?php echo $record_blood['num'] ?></td>
                            <td><?php echo $record_blood['date'] ?></td>
                            <td><?php echo $record_blood['name'] ?>(<?php echo $record_blood['account'] ?>)</td>
                            <td>
                              <form action="blood_history_data.php" method="get">
                                <button type="submit" class="btn" style="text-decoration:underline;" name="num_index" value="<?php echo $record_blood['num'] ?>"><i class='	fas fa-eye'></i></button>
                              </form>
                            </td>
                          </tr>
                          <?php } ?>
