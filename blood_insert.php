    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <form action="insert.php?blood_num=<?php echo $blood_num ?>" method="POST">
          <input type="hidden" name="insert" value="blood">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-xl-12">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">新增血液資料</span></h3>
                      <div class="mb-4 row" style='justify-content: space-evenly'>
                        ...
                        <div class="mb-3 col-md-2">
                          <input type="date" class="form-control" name="blood_record_time">
                        </div>
                      </div>
