<?php 
    ...
    $_SESSION['blood_num_index'] = $record_blood['num'];

    $sql_revise = "SELECT * FROM revise where id='$id' and revise_table='血液資料' and blood_num='$record_blood[num]' order by date desc ";
