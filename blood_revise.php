            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form action="blood_revise.php" method="get">
                      ...
                      <style>
                        ...
                        <table class="table" style="text-align:center;">
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='血液資料' AND account='$selection' order by date desc";
                              $result_revise = mysqli_query($link, $sql_revise);
                            }else{
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='血液資料' order by date desc";
                              $result_revise = mysqli_query($link, $sql_revise);
                            }
                           while($record_revise = mysqli_fetch_assoc($result_revise)){?>
                          <tr>
                            <td><?php echo $record_revise['blood_num'] ?></td>
                            <td><?php echo $record_revise['revise_column'] ?></td>
                            <td><?php echo $record_revise['original_data'] ?></td>
                            <td><?php echo $record_revise['new_data'] ?></td>
