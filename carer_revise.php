<?php
  ...
  $sql_selection = "SELECT * FROM user WHERE doctor=1 or personal_manager=1";
           ...
           <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <div class="menu-link">
                ...
                <div ><?php echo $record_basic['id'] ?></div>
              </div>
            </li>
            <li class="menu-item">
              <div class="menu-link">
                <i class="menu-icon tf-icons fas fa-user-alt"></i>
                <div ><?php echo $record_basic['name'] ?></div>
              </div>
            </li>
            <?php } ?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row" align="center">
                <div class="col-md-12">
                  <div class="card mb-4"> 
                    <div class="card-body">
                    <form action="carer_revise.php" method="get">
                      ...
                      <style>
                        ...
                        <table class="table" style="text-align:center;">
                          ...
                          <?php 
                            ...
                            if(!empty($selection)){
                              $sql_revise = "SELECT * FROM revise where id='$id' AND revise_table='照顧者資料' AND account='$selection' order by date desc";
                          ...
                          <tr>
                            ...
                            <td>
                              <?php 
                                if($record_revise['original_data'] == '0'){echo '不識字';} 
                                else if($record_revise['original_data'] == '0*'){echo '識字，未受正規教育';}
                                else if($record_revise['original_data'] == '6'){echo '國小';} 
                                else if($record_revise['original_data'] == '9'){echo '國中';} 
                                else if($record_revise['original_data'] == '12'){echo '高中(職)';} 
                                else if($record_revise['original_data'] == '6*'){echo '特教班-國小';} 
                                else if($record_revise['original_data'] == '9*'){echo '特教班-國中';} 
                                else if($record_revise['original_data'] == '12*'){echo '特教班-高中職';} 
                                else if($record_revise['original_data'] == '14'){echo '五專';} 
                                else if($record_revise['original_data'] == '16'){echo '大學(二三專)';} 
                                else if($record_revise['original_data'] == '18'){echo '研究所以上';} 
                                else if($record_revise['original_data'] == '其他'){echo '其他';}
                                else{echo $record_revise['original_data'];} 
                              ?>
                            </td>
                            <td>
                              <?php
                                if($record_revise['new_data'] == '0'){echo '不識字';} 
                                else if($record_revise['new_data'] == '0*'){echo '識字，未受正規教育';}
                                else if($record_revise['new_data'] == '6'){echo '國小';} 
                                else if($record_revise['new_data'] == '9'){echo '國中';} 
                                else if($record_revise['new_data'] == '12'){echo '高中(職)';} 
                                else if($record_revise['new_data'] == '6*'){echo '特教班-國小';} 
                                else if($record_revise['new_data'] == '9*'){echo '特教班-國中';} 
                                else if($record_revise['new_data'] == '12*'){echo '特教班-高中職';} 
                                else if($record_revise['new_data'] == '14'){echo '五專';} 
                                else if($record_revise['new_data'] == '16'){echo '大學(二三專)';} 
                                else if($record_revise['new_data'] == '18'){echo '研究所以上';} 
                                else if($record_revise['new_data'] == '其他'){echo '其他';}
                                else{echo $record_revise['new_data'];}
                              ?>
                            </td>
