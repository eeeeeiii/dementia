        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <div class="menu-inner-shadow"></div>
           ...
           <ul class="menu-inner py-1">
            <?php if ($record_user["pass"]==1 && isset($record_user["name"])){?>
              <li class="menu-item">
                <div class="menu-link">
            ...
            <!-- Dashboard -->
            <?php
            if(isset($record['id'])&&($record_user['pass']==1)&&(isset($record_user['name']))){
          ?>
            <!-- 病人名及病歷號 -->
          ...
          <?php }else{ ?>
            <!-- <hr style="background-color : lightgray; width: 75%;  margin-left: auto; margin-right: auto;">
              ...
              <li class="menu-item active">
                  <a href="self.php" class="menu-link">
        ...
        <nav
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <?php if(($record_user['name'] == null or $record_user['phone'] == null or $record_user['service'] == null )&&$record_user['pass'] == 0 ) {?>
                <font color='#6A6AFF' size="4"><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;&nbsp;請填寫完個人基本資料及更改密碼以使用系統完整功能！&nbsp;&nbsp;</font>
              <?php } elseif($record_user['pass'] == 0 ) {?><font color='#6A6AFF' size="4"><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;&nbsp;請記得更改密碼以使用系統完整功能！</font>
              <?php } elseif($record_user['name'] == null or $record_user['phone'] == null or $record_user['service'] == null){?>
              <font color='#6A6AFF' size="4"><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;&nbsp;請填寫完個人基本資料以使用系統完整功能！&nbsp;&nbsp;</font>
              <?php } elseif($record_user['gender'] == null or $record_user['birth'] == '0000-00-00'){?>
                <font color='#6A6AFF' size="4"><i class="fas fa-exclamation-triangle"></i>&nbsp;&nbsp;&nbsp;請填寫完個人基本資料！&nbsp;&nbsp;</font>
              <?php } ?>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4"> 
                    ...
                    <h3 class="fw-bold py-3 mb-4" style='text-align:center'><span class="text">個人資料</span></h3>

                    
              <?php if (isset($record_user["name"])){ ?>
              <form id="myForm" action="revise_sure.php?pass=<?php echo $record_user["pass"]?>&revise=self&num=1" method="POST">
              <?php } ?>
              <?php if ($record_user["name"]==null){ ?>
              <form  action="revise.php?pass=<?php echo $record_user["pass"]?>&revise=self&num=0" method="POST">
              <?php } ?>
                  <input type="hidden" name="revise" value="self">
                      <div class="row">
                        <div class="row mb-4" style='justify-content: space-evenly'>
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:150px;'>帳號</label>
                          <div class='col-md-4'  id="container">
                            <input type="text" class="form-control" name="account" value="<?php echo $record_user['account'] ?>" readonly>
                          </div>
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:120px;'>密碼</label>
                          <div class='col-md-4'>
                            <input type="password" class="form-control" name="final_id" value="<?php echo $record_user['password'] ?>" readonly>
                          </div>
                        </div>
                        <hr></hr>
                        ...
                        <div class="row mb-4" style='justify-content: space-evenly'>
                          ...
                          <div class='col-md-4'>
                            <input type="text" class="form-control" name="name" value="<?php echo $record_user['name'] ?>" required >
                          </div>
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:120px;'>生日</label>
                          <div class='col-md-4'>
                            <input type="date" class="form-control" name="birth" value="<?php echo $record_user['birth'] ?>">
                          </div>
                        </div>
                        <div class="row mb-4" style='justify-content: space-evenly'>
                          ...
                          <div class='col-md-4'>
                            <select class="select2 form-select" name="gender">
                              <?php if($record_user['gender'] == '男'){ ?> 
                                <option></option>                       
                                <option value="男" selected>男</option>
                                <option value="女">女</option>
                              <?php }else if($record_user['gender'] == '女'){ ?>
                                <option></option>                       
                          ...
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:120px;'>電話</label>
                          <div class='col-md-4'>
                            <input type="text" class="form-control" name="phone" value="<?php echo $record_user['phone'] ?>" required >
                          </div>
                        </div>
                        <div class="row mb-4" style='justify-content: space-evenly'>
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:150px;'>信箱</label>
                          <div class='col-md-4'>
                          <input type="text" class="form-control" name="email" value="<?php echo $record_user['email'] ?>" required >
                        </div>
                          <label class="col-form-label" style='font-size:16px;text-align:center;width:120px;'>服務單位</label>
                          <div class='col-md-4'>
                          <input type="text" class="form-control" name="service" value="<?php echo $record_user['service'] ?>" required>
                          </div>
                        </div>
                        ...
                        <?php if(isset($record_user['name'])) { ?>
                          ...
                          <button id="openModalButton" type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#modalChange" onclick="openModal(this)" data-value="<?php echo $record_user['account'] ?>">更改密碼</button>
                        <?php } else { ?>
          ...
          function openModal(button) {
            ...
            $('.modal').modal('show');// 開啟 Modal
          }
        </script>

          <form id="passwordchange" action="password_change.php" method="POST">
            <div class="modal fade" id="modalChange" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h3 class="modal-title" id="modalCenterTitle"><b>更改密碼(<span id="modalValue"></span>)</b></h3>
                    <input type="hidden" name="modalValue" id="modalValueInput">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                  <input type="text" class="form-control" name="account" value="<?php echo $record_user['account'] ?>" style="border-color: #8592a3;" placeholder="帳號" readonly><br>
                  <input type="password" class="form-control" name="password" style="border-color: #8592a3;" placeholder="原密碼" required><br>
                  <input type="password" class="form-control" name="newpassword" style="border-color: #8592a3;" placeholder="新密碼" required><br>
                  <input type="password" class="form-control" name="newpassword2" style="border-color: #8592a3;" placeholder="確認新密碼" required>
                  </div>
